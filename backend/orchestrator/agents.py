...
LINKEDIN_AGENT_PROMPT = GENERAL_AGENT_PROMPT + (
    ...
    "every step by observing the result, never assuming a click worked.\n\n"
    ...
    "e.g. Italy geoUrn=103350119). 'full' mode opens each profile to enrich, 'short' reads result cards only. "
...
LEADGEN_AGENT_PROMPT = LINKEDIN_AGENT_PROMPT + (
    ...
    "beat one loose query. Use short mode to build breadth fast and full mode to enrich the most promising. "
